...
public class activity_result2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<bill_item> billItems = getIntent().getParcelableArrayListExtra("bill_items");
        ...
        showResultDialog(ttlAmount, numOfPpl, billItems);
    }

    private void showResultDialog(double ttlAmount, int numOfPpl ,ArrayList<bill_item> billItems) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        View dialogView = getLayoutInflater().inflate(R.layout.activity_result2, null);

        TextView tvTitle = dialogView.findViewById(R.id.tv_title2);
        TextView tvResult = dialogView.findViewById(R.id.tv_result2);
        Button btnOk = dialogView.findViewById(R.id.btn_ok2);
        Button btnShare = dialogView.findViewById(R.id.bt_share2);
        ...
        // Now you can loop through the billItems ArrayList to display each item and its price
        ...
        btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                shareBody.append("Number of People: ").append(numOfPpl);
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                saveHistory(ttlAmount, numOfPpl, billItems);
                finish();
               // finishAffinity();
            }
        });
    ...
    private void saveHistory(double ttlAmount, int numOfPeople, ArrayList<bill_item> billItems) {
        ...
        Gson gson = new Gson();
        HistoryItem newHistoryItem = new HistoryItem(ttlAmount, numOfPeople, new ArrayList<>(), new ArrayList<>(), billItems, getCurrentDate());
